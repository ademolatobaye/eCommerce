...
if (isset($_REQUEST['invoicenumber'])) {
    ...
    echo "<script>alert('Order successfully deleted.'); window.location.href='orders.php';</script>";
    exit();
    ...
    echo "<script>alert('Order item successfully deleted.'); window.location.href='orders.php';</script>";
    exit();
}
?>