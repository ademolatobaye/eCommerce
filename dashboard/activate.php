...
if(isset($_REQUEST['id'])){
    ...
    if(mysqli_query($conn, $sql)){
        if ($vendor && !empty($vendor['vendor_email'])) {
            ...
            $mail->Subject    = "Vendor Account Activated";
            ...
            <body style='font-family: Arial, sans-serif; background-color: #f4f6f9; padding: 20px;'>
                <div style='max-width: 600px; background: #fff; margin: 0 auto; padding: 30px; border-radius: 8px;'>
                    <h2 style='color: #4B0082;'>Account Re-Activated</h2>
                    <p>Dear <b>" . htmlspecialchars($vendor_name) . "</b>,</p>
                    <p>Your vendor account for <b>" . htmlspecialchars($store_name) . "</b> has been successfully <b>ACTIVATED</b>.</p>
                    <p>You can now access your dashboard and resume managing your products and orders.</p>
