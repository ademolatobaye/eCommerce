...
<head>
    ...
    <title><?php echo $business_name; ?> - USER OTP</title>
                        ...
                        <div class="tab tab-nav-boxed tab-nav-center tab-nav-underline">
                            ...
                            <div class="tab-content">
                                <div class="tab-pane active" id="sign-up">
                                    ...
                                    <p class="text-muted text-center mb-4">Please enter the OTP (one time password) to reset your password. A code has been sent to <span class="text-dark text-4"><?php echo $customer_email;?></span></p>
                                    ...
                                    <form id="otp-screen" method="post">
                                        ...
                                        if(isset($_REQUEST["verify"])){
                                            if (isset($_SESSION['otp_time']) && (time() - $_SESSION['otp_time']) > 300) {
                                                echo "<script>alert('OTP has expired after 5 minutes! Please request a new one.'); window.location.href='user-newotp';</script>";
                                                exit();
                                            }
                                            $n1=$_REQUEST["n1"];
                                            $n2=$_REQUEST["n2"];
                                            ...
                                            if($dbotp!=$newotp){
                                                ...
                                                if($result){
                                                    ...
                                                    window.location.href='user-newpassword'</script>";
                                                }
                                            }
                                        }
                                        ?>
                                        ...
                                        if (remaining > 0) {
                                            const interval = setInterval(() => {
                                                ...
                                                if (remaining <= 0) {
                                                    ...
                                                    window.location.href = 'user-newotp';
                                                } else {
                                    ...
                                    <p class="text-center mt-4">Not received your code? <a href="user-resend-newotp" class="text-primary">Resend code</a></p>
                                </div>
                            </div>
                        </div>
                    </div>
