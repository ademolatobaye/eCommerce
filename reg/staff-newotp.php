                            ...
                            <div class="tab-content">
                                <div class="tab-pane active" id="sign-up">
                                    ...
                                    <form id="otp-screen" method="post">
                                        ...
                                        if(isset($_REQUEST["verify"])){
                                            if (isset($_SESSION['otp_time']) && (time() - $_SESSION['otp_time']) > 300) {
                                                echo "<script>alert('OTP has expired after 5 minutes! Please request a new one.'); window.location.href='staff-newotp';</script>";
                                                exit();
                                            }
                                            $n1=$_REQUEST["n1"];
                                            $n2=$_REQUEST["n2"];
                                    ...
                                    <p class="text-center mt-4">Not received your code? 
                                        <a href="staff-resend-newotp" class="text-primary" id="resend-link" style="pointer-events: none; opacity: 0.4;">Resend code</a>
