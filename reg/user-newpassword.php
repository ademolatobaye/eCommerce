                                ...
                                <div class="tab-pane active" id="sign-up">
                                    <form id="loginForm" method="post" onsubmit="return check()">
                                        ...
                                        if(isset($_REQUEST["submit"])){
                                            ...
                                            $sql = "UPDATE customertable SET `password`= '$hashed_password' WHERE customer_email = '$customer_email'";
                                            $result=mysqli_query($conn, $sql);
                                            if($result){
                                        ...
                                        <div class="form-group mb-4">
                                            ...
                                            <div style="position: relative;">
                                                <input type="password" name="password" class="form-control" id="password" required placeholder="Enter new password" oninput="return check()" style="padding-right: 45px;">
                                       ...
                                       <span id="error" class="d-block mt-2 font-weight-bold"></span>
                                        ...
                                        <button type="submit" name="submit" class="btn btn-primary w-100 mt-4" onclick="return confirm('Are you sure to reset your password?')">Submit</button>
