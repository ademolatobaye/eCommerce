                    ...
                    <tbody>
                        ...
                        <tr>
                            <td style='padding: 0 30px 20px; text-align: center;'>
                                ...
                                <p style='margin-bottom: 10px;'>Your NEW OTP to complete your registration as a staff on $business_name is:</p>
...
if ($mail->send()) {
    echo "<script>alert('A new OTP has been sent to your email.'); window.location.href='staff-otp';</script>";
} else {
    echo "<script>alert('Failed to send OTP email. Please try again.'); window.location.href='staff-otp';</script>";
}
exit();
?>