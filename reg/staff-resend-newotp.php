...
$email_setting = $setting_row['email'];
...
$mail->Subject    = "NEW RESET PASSWORD OTP";
                    ...
                    <tbody>
                        ...
                        <tr>
                            <td style='padding: 0 30px 20px; text-align: center;'>
                                ...
                                <p style='margin-bottom: 10px;'>Your NEW OTP to reset your staff password on $business_name is:</p>
...
if ($mail->send()) {
    echo "<script>alert('A new password reset OTP has been sent to your email.'); window.location.href='staff-newotp';</script>";
} else {
    echo "<script>alert('Failed to send OTP email. Please try again.'); window.location.href='staff-newotp';</script>";
}
exit();
?>