...
<head>
    ...
    <title><?php echo $business_name; ?> - STAFF LOGIN</title>
                                    ...
                                    <form id="loginForm" method="post">
                                        ...
                                        <div class="form-group mb-0">
                                            ...
                                            <div style="position: relative;">
                                                <input type="password" class="form-control" name="password" id="password" required placeholder="Enter your password" style="padding-right: 45px;">
                                                <span onclick="togglePassword('password', 'eyeIcon2')" style="position:absolute; right:15px; top:50%; transform:translateY(-50%); cursor:pointer; color:#4B0082; display:inline-flex; align-items:center; z-index:10;">
