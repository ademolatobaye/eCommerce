...
<head>
    ...
    <title><?php echo $business_name; ?> - USER REGISTER</title>
...
//Email subject
	$mail->Subject = "REGISTRATION COMPLETION";
//Set sender email
                        ...
                        <tbody align='left'>
                            <tr>
                                <td style='padding: 0 30px 20px;'>
                                    ...
                                    <hr>
                                    <p style='margin-bottom: 10px;'>If you have any questions or need help, feel free to contact us. Do well to enjoy <strong>$business_name</strong>.</p>
                                    <hr>
...
//Finally send email
	if ($mail->send()) {
        ...
        echo "<script>alert('Dear $fullname, your account has been created, but failed to send confirmation email.');
         window.location.href='user-login';</script>";
    }
}
            }
